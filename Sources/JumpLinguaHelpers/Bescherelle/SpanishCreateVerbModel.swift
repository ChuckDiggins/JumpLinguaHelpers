...
//    verbModels.append(thisVerb)
    ...
    thisVerb.appendSuffix(suffix: "aillar")
    thisVerb.appendSuffix(suffix: "feinar")
    ...
    thisVerb.appendExcludeSuffix(suffix: "peinar")
    thisVerb.appendExcludeSuffix(suffix: "irmar")
